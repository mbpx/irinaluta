...
@Component({
  selector: 'app-display3d-v2',
  templateUrl: './display3d-v2.component.html',
  styleUrls: ['./display3d-v2.component.sass']
})
export class Display3Dv2 implements OnInit, AfterViewInit {
  ...
  private startRenderingLoop() {
    ...
    const component: Display3Dv2 = this;
